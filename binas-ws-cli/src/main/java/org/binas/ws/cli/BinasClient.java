...
public class BinasClient implements BinasPortType {
    ...
    public BinasClient(String uddiURL, String wsName) throws BinasClientException, UDDINamingException {
    ...
    /** UDDI lookup */
    private void uddiLookup() throws BinasClientException, UDDINamingException {
